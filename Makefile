...
SERVICE_CAPS = BatchBiogeochemicalReactionModel
SPEC_FILE = BatchBiogeochemicalReactionModel.spec
URL = https://kbase.us/services/batchbiogeochemicalreactionmodel
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
